...
import com.example.readnews.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener {
	...
	private void initHeaderViewAndFooterViewAndListView(Context context) {
		...
		mFooterView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.pull_down_footer, null);
	...
	public boolean onMotionUp(MotionEvent ev) {
		...
		if (ScrollOverListView.canRefleash) {
			...
			Log.i(TAG, "PullDownView中的onMotionUp");
