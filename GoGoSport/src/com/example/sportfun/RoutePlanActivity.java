...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		fromLatLng = new LatLng(b.getDouble("fromX"),b.getDouble("fromY"));
		toLatLng = new LatLng(b.getDouble("toX"),b.getDouble("toY"));
		//
      ...
      // mBaidumap.hideInfoWindow();
       ...
       // drive.setPressed(true);
        PlanNode stNode = PlanNode.withLocation(fromLatLng);
