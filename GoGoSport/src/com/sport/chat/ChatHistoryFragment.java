...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v=inflater.inflate(R.layout.fragment_conversation_history, container, false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		final String st = "Cant_chat_with_yourself";
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.delete_message) {
			...
			// 更新消息未读数
			((TotalActivity) getActivity()).updateUnreadLabel();
	 ...
	 */
	public void refresh() {
		List<EMContact> recentChatusersNum = loadUsersWithRecentChat();
		Log.i("recentChatusersNum", recentChatusersNum.size()+"");
	...
	private List<EMContact> loadUsersWithRecentChat() {
		...
		//Hashtable<String, EMConversation> allConversation =	EMChatManager.getInstance().getAllConversations();
		//Log.i("allConversation", allConversation.size()+"");
